...
START_TEST(s21_sub_matrix_6) {
  ...
  B.matrix[1][0] = 0, B.matrix[1][1] = 1, B.matrix[1][2] = 2;
  B.matrix[2][0] = 2, B.matrix[2][1] = 4, B.matrix[2][2] = 6;
  ck_assert_int_eq(s21_sub_matrix(&A, &B, &result), OK);
  eq_matrix.matrix[0][0] = 0, eq_matrix.matrix[0][1] = 2,
  eq_matrix.matrix[0][2] = 2;
  eq_matrix.matrix[1][0] = 4, eq_matrix.matrix[1][1] = 4,
  eq_matrix.matrix[1][2] = 4;
  eq_matrix.matrix[2][0] = 5, eq_matrix.matrix[2][1] = 4,
  eq_matrix.matrix[2][2] = 3;
  ck_assert_int_eq(s21_eq_matrix(&result, &eq_matrix), SUCCESS);
  s21_remove_matrix(&A);
  s21_remove_matrix(&B);
  s21_remove_matrix(&result);
